function shapeAnd(id,x,y,size){
	...
	andShape.set({fill:"#fff",stroke:"#666",id:id,width:100,height:100,top:y+100,left:x+100})
	canvas.add(andShape);
	canvas.renderAll();
...
function shapeOr(id,x,y,size){
	...
	orShape.set({fill:"#fff",stroke:"#666",id:id,width:100,height:100,top:y+100,left:x+100})
	canvas.add(orShape);
	canvas.renderAll();
...
function shapeNot(id,x,y,size){
	...
	notShape.set({fill:"#fff",stroke:"#666",id:id,width:100,height:100,top:y+100,left:x+100})
	canvas.add(notShape);
	canvas.renderAll();
